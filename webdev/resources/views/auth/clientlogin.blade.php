...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default"><a class="btn btn-link" style="float: right; font-size: 25px;" href="{{route('client.register')}}">
                    Register
                </a>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('client.loginclient') }}">
                        {{ csrf_field() }}
